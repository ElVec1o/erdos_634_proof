...
rigor: the column $(0,e,2e)$ is excluded at $e=2$ for every coprime $f>4$, by counting --- the
west chain and its mirror force six $c$-letters against the four available --- so the base walk
there is the walls form unconditionally. At $e=3$ the same forcing pins the column word to
$c^3b^3c^3$, and the $V_2$ step, whose anchors are interior, is the named residue. Engine
