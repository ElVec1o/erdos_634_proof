...
previously undetermined value up to $68$: no triangle can be cut into $14$, $15$, $21$, $22$, $30$,
$33$, $35$, $38$, $39$, $42$, $51$, $55$, $56$, $57$, $60$, $63$, $66$, or $70$ congruent triangles
($46$, $62$, $78$ likewise); triangles \emph{can} be cut into $44$ and (by Beeson's four-component
construction) $77$ congruent triangles;
...
$\Q(\sqrt{15})$). It is verified independently of the search: all $44$ triangles have squared
side multiset exactly $\{4,9,16\}$; they are pairwise interior-disjoint; every vertex lies in the
closed target and no tile edge crosses the target boundary; and the areas sum exactly to the
target's. Disjointness with exact equality of total area and containment forces coverage, so this
is an $N$-tiling in the strict sense. The consequence follows by subdividing each tile into $m^2$
similar copies.
\end{proof}
...
No triangle can be cut into $51$, $55$, $56$, $57$, $60$, $62$, $63$, $66$, $70$, or $78$
congruent triangles.
\end{theorem}
...
branch at the squarefree values $51$, $55$, $57$; the boundary algorithm (Lemmas 11.2--11.17 of
...
\begin{remark}
The equilateral exhaustion at $56$ settles the $m{=}1$ case of Zhang's equiconstructibility
family for the tile $(8,7,13)$: the side-$56$ equilateral triangle is \emph{not} tileable by
$(8,7,13)$, exactly as Zhang's Conjecture~2 predicts (his construction realizes $X=56m$ for
$m\ge9$). It also closes the $m{=}1$ route of his Proposition~9(1) to the $F_1$ instance
...
$51,55,56,57,60,62,63,66,70,78$ by Theorem~\ref{thm:frontier3}, \emph{$44$ realizable} by
...
commensurably realized ($45,48,49,50,52,53,54,58,61,64,65,68$) or prime ($47,53,59,67$), the
membership of \emph{every $N\le68$} is now determined. The smallest undetermined values are
$N=69$ (two isosceles-$(\alpha{+}\beta)$ instances, one exhausted at $523$ nodes, the other in
progress) and $N=76$ ($\gamma=2\alpha$ empty by the boundary algorithm; one
isosceles-$(\alpha{+}\beta)$ instance in progress); after them every value through $80$ is
determined ($71,79$ prime, $72$--$75$ and $80$ realized, $77$ realized, $78$ excluded).
