...
\ref{sec:reduction}--\ref{sec:isosceles}, together with the shape enumeration of
Section~\ref{sub:shapes}) are self-contained given those inputs, with the arithmetic layer
...
$120^\circ$-triples up to $c\approx 9\times10^6$). As a positive control, both necessary conditions
...
in Lean~4 with Mathlib (\texttt{lean/Erdos634.lean}, thirteen theorems); every theorem depends only
