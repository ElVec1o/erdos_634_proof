...
\begin{proposition}[Corner figures]\label{prop:cornerfig}\lab{PROVED: the multiplicity arithmetic VERIFIED}
...
\begin{proposition}[Equilateral admissibility]\label{prop:eqspec}\lab{PROVED}
