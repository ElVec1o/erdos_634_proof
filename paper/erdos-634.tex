...
For $e\ge2$ the base walk is determined \emph{on the separated members}, and it is worth being
precise about how much of the residue that is. Separation, $f^2>2ef+e^2$, is the condition
...
$f/e=1.2$ and is \emph{not} separated. The determined-walk result should therefore not be read as
...
meaning one with $f^2>2ef+e^2$, admits exactly three edge decompositions; the $\gamma$-trap deletes the one with no
