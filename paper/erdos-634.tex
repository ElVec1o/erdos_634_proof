...
$33$, $35$, $38$, $39$, $42$, $51$, $55$, $56$, $57$, $60$, $63$, $66$, $69$, $70$, or $76$ congruent triangles
($46$, $62$, $78$ likewise, and $79$ --- a prime --- by the main theorem); triangles \emph{can} be cut
into $44$, $77$ (by Beeson's four-component construction), and $80$ (a sum of two squares) congruent triangles;
...
one of: $3\alpha+2\beta=\pi$, for which $N$ is not prime (\cite{BeesonIII}, but see
Remark~\ref{rem:b3prime} and Proposition~\ref{prop:b3prime}, which machine-check the
$(2\alpha,\beta,\alpha{+}\beta)$ core in Lean and supply a correct proof for the
base-$(\alpha{+}\beta)$ target in place of Beeson's flawed Theorem~18); an isosceles tile with
...
impossible for an odd prime with $\gcd(e,f)=1$. For the base-$\alpha$ target no prime candidate
satisfies the analogous equation-plus-square pair (verified for $f<300$); its exclusion in our
sweeps additionally uses Beeson's divisibility $g\mid M$ (Theorem~19), an independent necessity
unaffected by the Theorem-18 flaw.
\end{remark}
...
No triangle can be cut into $76$ congruent triangles. Every $N\le 80$ is thereby determined: the
realizable values are exactly $1$--$13$'s known members together with $44,77,80$ and the standard
commensurable and prime\,$\equiv1\!\pmod4$ values, and all others are excluded.
\end{theorem}
\begin{proof}
...
exclusions through $78$; and the four-component and biquadratic constructions realize $77$ and $80$.
\end{proof}
...
\emph{every $N\le80$} is now determined (Theorem~\ref{thm:frontier4}).
