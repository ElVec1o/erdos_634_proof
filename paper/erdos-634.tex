...
than the isoperimetric scale permits. Proving it for the base-$\beta$ target would close the
sub-golden families at every scale --- an infinite set including the open primes $83$, $167$, $179$
--- and would do so by an argument already known to work on a neighbouring target.
\end{remark}
