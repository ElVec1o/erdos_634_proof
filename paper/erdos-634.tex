...
this is Beeson's Theorems~8 and~12; the arithmetic core of the former --- the first tiling equation
$N+M^2=2K^2$ with $K\mid N$ admits no odd prime --- we machine-check in Lean
(\texttt{lean/Beeson3NotPrime.lean}). The isosceles target with base angles $\alpha{+}\beta$ is
