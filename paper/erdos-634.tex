...
previously undetermined value up to $55$: no triangle can be cut into $14$, $15$, $21$, $22$, $30$,
$33$, $35$, $38$, $39$, $42$, $51$, $55$, or $57$ congruent triangles ($46$ and $62$ likewise);
...
that single equilateral instance, for which our search remains inconclusive (the tree is large;
it is the $m{=}1$ member of Zhang's equiconstructibility family for this tile, which his
construction reaches only from $m\ge9$). Likewise $N=60$ reduces to its equilateral instance
alone (tile $(5,3,7)$, side $30$): its two isosceles-$(\alpha{+}\beta)$ instances are exhausted
as well ($M{=}2$: tile $(56,15,64)$, target $(240,240,210)$, $123003$ nodes; $M{=}6$: tile
$(4,15,16)$, target $(120,120,30)$, $39$ nodes).

\begin{theorem}\label{thm:frontier3}
No triangle can be cut into $51$, $55$, $57$, or $62$ congruent triangles.
\end{theorem}

\begin{proof}
The branch sweeps and the six exhaustive searches above; dependencies as in
...
$51,55,57,62$ by Theorem~\ref{thm:frontier3}, \emph{$44$ realizable} by Theorem~\ref{thm:44},
$28$ realized by Beeson's triquadratic tilings \cite{BeesonIII}, and the remaining values
$\le55$ commensurably realized ($45,48,49,50,52,53,54$) or prime ($47,53$), the membership of
\emph{every $N\le55$} is now determined. The smallest undetermined value, to our knowledge, is
$N=56$, whose membership is equivalent (by the reductions above) to the single
$2\pi/3$-equilateral instance of side $56$ on the tile $(8,7,13)$.
