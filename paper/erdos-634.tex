...
\begin{proposition}[Base-$\alpha$ prime exclusion, replacing {\cite[Thm.~20]{BeesonIII}}]\label{prop:isoalphaprime}\lab{PROVED}
...
\begin{proposition}[Dissection basics]\label{prop:dissection}\lab{PROVED}
...
\begin{proposition}[Vertex figures]\label{prop:vertexfigures}\lab{PROVED}
...
\begin{proposition}[Corner figures]\label{prop:cornerfig}\lab{PROVED}
...
\begin{proposition}[$b$ is unsplittable]\label{prop:bunsplit}\lab{PROVED}
...
\begin{proposition}[Base-$(\alpha{+}\beta)$ prime exclusion, correcting {\cite[Thm.~18]{BeesonIII}}]\label{prop:b3prime}\lab{PROVED}
...
\begin{proposition}[Rationality from integrality of the invariant]\label{prop:rationality}\lab{PROVED}
...
\begin{proposition}[The invariant product]\label{prop:product}\lab{PROVED}
...
\begin{corollary}[Tile-similar target, citation-free]\label{cor:similar}\lab{PROVED}
