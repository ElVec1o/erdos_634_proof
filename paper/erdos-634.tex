...
lattice theorem determines the refined spectrum exactly, exhibiting admissible values beyond
Zhang's constructed families (the smallest being $N=354$). Combining the spectra with the published
branch theorems and an exhaustive exact search of the surviving finite instances, we settle every
previously undetermined value up to $41$: no triangle can be cut into $14$, $15$, $21$, $22$, $30$,
$33$, $35$, $38$, or $39$ congruent triangles; $N=46$, previously the sharpest test of Zhang's
...
The refined spectrum coincides with Zhang's constructed family $N=m^2b(a+2b)$ exactly when $E=e$;
this holds for $(7,8,13)$ and $(5,16,19)$ (both have $E=e$), but not in general: in the
parametrization $a=m^2-n^2$, $b=2mn+n^2$, an odd prime $p$ with $p^2\mid n$ makes $p$ ``free''
($v_p(r)\ge v_p(e)$, since $r=-n(m-n)$), and the lattice is coarser than $e\Z$. The smallest such
tile is $(11,24,31)$ ($d=6$, $e=2$, $E=1$): the value $N=354=6\cdot59$ is admissible but lies
\emph{outside} the Zhang family $1416m^2$; likewise $(19,261,271)$ admits $N=15689=29\cdot541$.
These beyond-family admissible values are the new sharpest tests of sufficiency: either they are
tiled by constructions not in~\cite{Zhang}, or a necessary condition beyond the invariant kills
them.
\end{remark}
...
The pipeline is now mechanical, and it continues: $N=38$ dies in every branch by arithmetic
alone, while $33$, $35$ and $39$ each reduce to two isosceles-$(\alpha{+}\beta)$ instances (the
...
No triangle can be cut into $21$, $22$, $30$, $33$, $35$, $38$, $39$, or $46$ congruent
triangles.
\end{theorem}
...
a closed-form description of the set: that residual question concentrates in the equilateral
branch, where Laczkovich has related the possible $N$ to rational points on elliptic
curves~\cite{LaczkovichEll}, and in the sufficiency half of Zhang's conjecture, for which the
beyond-family values of Remark~\ref{rem:zhang} (the smallest being $N=354$) are now the sharpest
tests.
...
and $14,15,21,22,30,33,35,38,39,46$ by Theorems \ref{thm:frontier} and~\ref{thm:frontier2}, the
membership of every $N\le 41$ is now determined; the smallest undetermined values, to our
knowledge, are $N=42$ and $N=44$.
