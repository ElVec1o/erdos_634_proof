...
$p=0$ on every equal side, so Hypothesis (walls) \emph{holds unconditionally at every member with
$e=f-1$}. The tile counts are $N=2f^{2}+2f-1$, and the base-$\beta$ candidates among them --- primes
