...
Proposition~\ref{prop:unsplit} the edge $b$ is never a sum of two or more tile edges; so an interior
...
of Theorem~\ref{thm:pierce} is built on precisely such a straddle. The genuine tilings confirm the
failure: in the $44$-tiling six $b$-edges belong to a single tile although \emph{no} $b$-edge lies on
the boundary, and in the $99$-tiling thirty-three $b$-edges are unmatched against eleven on the
boundary --- twenty-two interior straddles. The correct relation is
\[
