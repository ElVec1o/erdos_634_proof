...
The evidence is that every sub-golden member ever tested is excluded, and the conjecture made a
successful prediction. Sub-golden members tested: $N=23$ $(2,3)$, $N=39$ $(3,4)$ and --- after this
conjecture was formulated --- $N=59$ $(4,5)$, all three exhausted. Both realized tilings, $44$ and
$99$, are super-golden (family $(1,2)$, $M^2/N=9/11$). The condition is necessary only, not
sufficient: $N=11,26,47,66,71,74,107$ are super-golden and excluded.
...
tiling of any sub-golden target refutes it. Two searches are live tests: $N=83$, the sub-golden family
$(5,6)$ at $m=1$, and $N=92$, the sub-golden family $(2,3)$ at $m=2$ --- the latter also testing
whether a family barred at $m=1$ can tile higher up, as $(1,2)$ does.
\end{remark}
