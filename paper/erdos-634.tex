...
\begin{proposition}[Vertex figures]\label{prop:vertexfigures}\lab{PROVED: the multiplicity arithmetic VERIFIED}
...
the criteria of Proposition~\ref{prop:eqspecint} and of~\cite[Thm.~3]{BeesonEq} respectively.
\end{proposition}
