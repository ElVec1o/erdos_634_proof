...
\]
The only known member of the family, the $44$-tiling ($m=2$), indeed carries \emph{zero} $b$-edges on
its entire boundary, consistent with this. Proving ``the base of a base-$\beta$ tiling never carries a
$b$-edge'' would close the whole gap --- including the $e=1$ cases now resting on
\cite[Lem.~6]{BeesonIII} --- and by Remark~\ref{rem:nogo} it cannot be proved by any linear
edge-direction invariant. We leave it as the sharp open problem.
\end{remark}
