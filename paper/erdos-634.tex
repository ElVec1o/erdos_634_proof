...
machine-checked: \texttt{lean/AngleSplit.lean}, \texttt{angle\_relation\_split}, from
$3\alpha+2\beta=\pi$, $\gamma=2\alpha+\beta$ and irrationality of $\alpha/\pi$). A base corner has
