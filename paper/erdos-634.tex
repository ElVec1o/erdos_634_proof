...
previously undetermined value up to $59$: no triangle can be cut into $14$, $15$, $21$, $22$, $30$,
$33$, $35$, $38$, $39$, $42$, $51$, $55$, $56$, or $57$ congruent triangles ($46$ and $62$ likewise);
...
\end{tabular}
\end{center}
(The three $N{=}63$ rows close its isosceles-$(\alpha{+}\beta)$ branch; $63$ itself remains open
through its $\gamma=2\alpha$ instance, see below.)
...
$(120,120,30)$, $39$ nodes); that final search is in progress.

\begin{theorem}\label{thm:frontier3}
No triangle can be cut into $51$, $55$, $56$, $57$, or $62$ congruent triangles.
\end{theorem}
...
branch at $51$, $55$, $57$, and the boundary algorithm (Lemmas 11.2--11.17 of \cite{BeesonIso},
implemented in \texttt{code/gamma2alpha.py}) for the $\gamma=2\alpha$ branch at $56$.
\end{proof}
...
$51,55,56,57,62$ by Theorem~\ref{thm:frontier3}, \emph{$44$ realizable} by Theorem~\ref{thm:44},
$28$ realized by Beeson's triquadratic tilings \cite{BeesonIII}, and the remaining values
commensurably realized ($45,48,49,50,52,53,54,58$) or prime ($47,53,59$), the membership of
\emph{every $N\le59$} is now determined. The smallest undetermined value, to our knowledge, is
$N=60$, whose membership is equivalent (by the reductions above) to the single
$2\pi/3$-equilateral instance of side $30$ on the tile $(5,3,7)$; after it, $63$, equivalent to
its $\gamma=2\alpha$ instance (tile $(9,7,12)$, target $(63,63,84)$) --- both searches are in
progress.
