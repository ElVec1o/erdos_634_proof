...
is exactly the realizability of the \emph{small} family members: Zhang's constructions cover
$m\ge9$ in certain residue classes, so the sharpest open instance is now the $m=1$ member
itself, e.g.\ $N=184=b(a+2b)$ on $(7,8,13)$ (target $(104,104,184)$), whose membership is not
decided by any known necessary condition and is exactly the kind of bounded question the engine
of Section~\ref{sub:frontier} addresses.
\end{remark}
...
members --- sharpest $N=184$ on $(7,8,13)$ --- and each such instance is individually decidable
