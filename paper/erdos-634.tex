...
$33$, $35$, $38$, $39$, $42$, $51$, $55$, $56$, $57$, $60$, $63$, $66$, $69$, or $76$ congruent triangles
...
triangles; the value $70$, previously excluded via a theorem of \cite{BeesonIII} whose proof we show
to be unsound, is undetermined pending a direct exhaustive search of its single surviving instance;
...
paper we resort to the direct corner-anchored search: for $N\le80$ the affected base-$\beta$
candidates are $N=11$ (tile $(2,3,4)$, exhausted, $135$ nodes) and, sharing the same status as their
Theorem-19 counterparts, $N=23,47,59,71$ (primes) and $N=39,66$ (composite); these searches are
straightforward but were run only after the defect surfaced, and at the time of writing $N=11$ and
$N=21$ (base-$\alpha$) have returned \textsc{exhausted}, with the remainder in progress. Any value
whose sole surviving branch is base-$\beta$ (or base-$\alpha$) and whose search has not returned is
deferred to the pending list (Remark~\ref{rem:seventy}). We flag this plainly: for the base-$\beta$
target our $3\alpha+2\beta$ prime argument rests on either \cite[Thm.~14]{BeesonIII} (whose printed
proof is unsound) or a per-value search, \emph{not} on a machine-checked general theorem --- the one
genuine gap remaining in the prime dichotomy.
\end{remark}
...
No triangle can be cut into $51$, $55$, $56$, $57$, $60$, $62$, $63$, $66$, $69$, or $78$
congruent triangles.
\end{theorem}
...
$63$; and \cite[Thm.~7]{BeesonEq} at $66$.
\end{proof}
...
Theorem~\ref{thm:frontier2} stands with its dependence on \cite[Thm.~19]{BeesonIII} removed.
\end{remark}
