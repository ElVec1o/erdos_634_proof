...
This suggests that $S^\ast$ is built multiplicatively from the branch-form values of the sporadic
tiles together with squares, and it sharpens the search targets: a value is a candidate for a
\emph{new} member of $S^\ast$ only if it is not a sum of two squares. Among the instances currently
