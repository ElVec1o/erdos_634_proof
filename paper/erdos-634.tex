...
quoted per-instance exhaustions. Of the four reopened instances, three are excluded by
exhaustive search (verified: $14$ at $678$ nodes, $46$ at $4\,685$, $56$ at $4\,890\,763$;
instances generated by \texttt{code/engine/gen\_cevian.py}, byte-exact against the certified
members); the search at $62$ is running at the time of writing, and the exclusion of $62$ ---
alone among the composites below $90$ --- carries that caveat until it completes. The prime
exclusions are untouched throughout, resting on Theorem~\ref{thm:main} and the congruence class
alone.
\end{remark}
