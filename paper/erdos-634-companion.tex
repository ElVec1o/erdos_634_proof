...
along the stub line cannot cross the next block's $c$-edge. The termination therefore reduces to
the invariant induction: when the trailing $a$-letters are exhausted, no continuation tile exists,
the final stub must be covered by whole edges, and $x\,a+y\,b+z\,c=1$ is the gap. Also open: the
