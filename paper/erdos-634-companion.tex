...
\end{enumerate}
\textup{Formalised as \texttt{column\_criterion\_identity}, \texttt{column\_criterion},
\texttt{k\_one\_forces\_f\_le\_two\_e\_sub\_one}, \texttt{residue\_step} and \texttt{g\_strict\_drop}
in \texttt{lean/Frontier.lean}; unlike the other Lean citations in this note these five await a
kernel check, so the proof below is the warrant for the statement.}
\end{proposition}
