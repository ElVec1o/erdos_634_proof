...
$3\le f\le39$. An adversarial review in a fresh session, working from the written proof alone, has not
yet been carried out, and the result should be read with that outstanding.
\end{remark}
