...
\begin{lemma}[Angle calculus]\label{lem:anglecalc}\lab{VERIFIED}
...
\begin{lemma}[Thick-side quantization]\label{lem:sidequant}\lab{CONJECTURE}
...
\begin{lemma}[The thick base dichotomy]\label{lem:basedi}\lab{PROVED}
...
\begin{corollary}[The base trichotomy and dichotomy without separation]\label{cor:basedi2e}\lab{PROVED}
...
\begin{corollary}[A uniform two-case side problem]\label{cor:ptwo}\lab{CONJECTURE}
...
\begin{proposition}[The extra base columns at a close pair]\label{prop:closepaircolumns}\lab{PROVED}
