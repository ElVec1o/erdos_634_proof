...
in $297$ nodes and $(0,0,5)$ gives \texttt{FOUND\_TILING} in $2\,223$. At $(4,9)$, $N=81$: the
...
The three \texttt{FOUND} runs are negative controls: a search exhausting both profiles would indicate a
malformed instance rather than a theorem. At $(4,9)$ that control is still running at the time of
