...
\begin{theorem}[The row fork kill]\label{thm:forkkill}\lab{CONJECTURE}
...
\begin{proposition}[The $A_2$ branch dies]\label{prop:a2branch}\lab{CONJECTURE}
...
\begin{theorem}[The block-two chain runs to arbitrary depth]\label{thm:elltwo}\lab{CONJECTURE}
...
\begin{theorem}[Reach three behind a thick block, and the pincer window]\label{thm:depthwindow}\lab{CONJECTURE}
