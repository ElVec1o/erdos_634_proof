...
Let the tile be inflated by $f$, so its sides are $fa$, $fb$, $fc$, and suppose each corner of the
inflated triangle is met by a single tile, that tile laying along the two sides the two flanks of the
corner angle. Then each side begins and ends with a prescribed edge, and its interior is a word over
$\{a,b,c\}$ of the residual length. At $(1,3)$ and $(3,7)$ the outcome is:
\[
\begin{array}{llll}
...
$(3,7)$, tile $(21,40,49)$: the residuals are $105$, $200$, $245$, with unique compositions
$5a$ and $5b$ for the first two, and $5c$ or $7a+2c$ for the third.
\end{proof}
...
same answer for the west side. The hypothesis of Proposition~\ref{prop:inflbdy} --- one tile per
corner, laying the corner angle's flanks --- is geometric and is not proved here; at $f=2$ it follows
from a tile count, since a $\gamma$-corner splits as $\{2\alpha,\beta\}$ into three tiles and
$3+1+1>f^2=4$, but that argument fails for $f\ge3$.
\end{remark}
