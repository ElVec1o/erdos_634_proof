...
\begin{remark}[The hypothesis $a<b$ is necessary, not convenient]\label{rem:abnecessary}
...
the shortest side. Deleting the hypothesis breaks it, with witnesses: at $(2,3)$, $(3,4)$, $(4,5)$ and
$(5,6)$ the tiles are $(6,5,9)$, $(12,7,16)$, $(20,9,25)$ and $(30,11,36)$, each with $b<a$, so a
$b$-edge also fits inside $|PJ|$. Since $b$ is a flank of $\alpha$, the conclusion ``$Y$ does not
present $\alpha$'' collapses at those members, and with it the whole section. The hypothesis is
witnessed necessary rather than assumed for convenience.
\end{remark}
