...
by $f$ (\texttt{overrun\_amounts}). The first of those is strictly below the minimal edge and so
is a gap, which is the sharpest form the residue has taken --- but closing it requires the same
anchoring the crossing question has always demanded.
\end{remark}
