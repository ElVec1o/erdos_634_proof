...
\begin{theorem}[Alignment of the mismatch ray]\label{thm:align}\lab{PROVED}
...
\begin{theorem}[Unique representation of $k\,b$]\label{thm:kbrep}\lab{PROVED}
...
\begin{theorem}[The angle $(\pi-\alpha)/2$]\label{thm:halfangle}\lab{PROVED}
...
\begin{theorem}[Walk structure at $m=1$]\label{thm:walkstruct}\lab{PROVED}
...
\begin{lemma}[c-chord dichotomy]\label{lem:cchord}\lab{PROVED}
...
\begin{lemma}[The $jb$-line partition]\label{lem:jbline}\lab{PROVED}
...
\begin{lemma}[The apex]\label{lem:apex}\lab{PROVED}
...
\begin{lemma}[The vertex census]\label{lem:census}\lab{PROVED}
...
\begin{lemma}[The apex identities]\label{lem:apexid}\lab{PROVED}
For every $(e,f)$,
\[
...
\begin{corollary}[The $p=1$ word needs two $c$-edges, so $e=f-1$ is rigid]\label{cor:twoc}\lab{PROVED}
...
\begin{proposition}[Sharp criterion for an extra base column]\label{prop:sharpcolumn}\lab{PROVED}
...
\begin{lemma}[Collar decomposition]\label{lem:collar}\lab{PROVED}
