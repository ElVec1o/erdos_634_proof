...
supplies one. The argument for $e^{2}$ being a gap needs $e^{2}<\min(a,b)$, which holds at $(3,7)$ but
fails at several members with $f$ close to $e$, so it is not family-wide.
