...
to any wall run, which is what the multiplicity and semigroup arguments consume. What remains: the
conversion of \texttt{wall\_partition}'s measure statement into the run-length equation, and the
