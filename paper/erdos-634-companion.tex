...
which is exactly the reason the corner-chain induction fails at interior $V_k$. What remains of (c)
is the indexing --- a map from a dissection and its base edge to an ordered list of orientations,
whose adjacency relation is that theorem --- and until it exists the combinatorial results still do
not apply to tilings.
\end{remark}
