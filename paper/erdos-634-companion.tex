...
($k=f$) or a first break occurs''. At $e=1$ the first alternative never occurs, and this can be seen
from the letter budget alone. A complete west block has $f$ $a$-feet on the base; feet are
