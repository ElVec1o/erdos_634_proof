...
\begin{theorem}[Walk structure at $m=1$]\label{thm:walkstruct}\lab{VERIFIED}
...
\begin{lemma}[The vertex census]\label{lem:census}\lab{VERIFIED}
...
\begin{proposition}[The orientation of a boundary $a$-run is monotone]\label{prop:orientmono}\lab{VERIFIED}
