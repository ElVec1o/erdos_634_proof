...
propagation: past an edge's far endpoint the ray may pass through a tile's interior instead of
along another edge. That single implication --- that the chain, once started at the pin, reaches
the boundary --- is the whole of what remains.
\end{remark}
