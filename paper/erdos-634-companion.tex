...
(\texttt{inter\_measure\_is\_dist}). What still separates this from the run equation is only
the identification of those distances with model or partial edge lengths, fed by
\texttt{congruent\_edge\_lengths}. Also open: the
