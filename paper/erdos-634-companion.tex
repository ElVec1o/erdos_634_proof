...
\begin{remark}[An unresolved tension in the reading of Hypothesis~\ref{hyp:walls}]\label{rem:wallsfix}
Two readings of the hypothesis are in circulation in this development and they are not equivalent. We
record the discrepancy rather than resolve it.
...
Three possibilities remain open: the block form is correct and Theorem~\ref{thm:e1reduce} shows it is
unsatisfiable at $e=1$, $m=1$, making the conditional results vacuous there; or the $p=0$ reading is
correct and the block wording needs amending; or the hypothesis is genuinely asymmetric and every
statement of the form ``$\mathrm{Hypothesis}~\ref{hyp:walls} \Leftrightarrow p=0$'' should be read as
applying to the west side only. The results of \S\ref{sub:apex} are unaffected either way: they are
statements about $p$ on a given equal side and stand on their own proofs.
\end{remark}
