...
\begin{proposition}[The relation lattice, and the interface floor]\label{prop:rellattice}\lab{PROVED}
...
\]
Every $n\in\Lambda$ has $f\mid n_b$, and every $n$ with $n_b=0$ lies in $\Z v_1$. Consequently a
nonzero relation has one-sided length at least $f\min(a,b)$, and \emph{every maximal straight
