...
Under the reading of Hypothesis~\ref{hyp:walls} as $p=0$, this establishes the hypothesis at every
such member. We state the theorem in terms of $p$, which is what the proof gives, because that reading
is not settled: see Remark~\ref{rem:wallsfix}.
\end{theorem}
