...
(\texttt{adjacent\_admissible}). What remains of (c) is therefore the map itself --- from a
dissection and its base edge to an ordered list of orientations --- and not any further geometric
fact; until that map exists the combinatorial results still do not apply to tilings.
\end{remark}
