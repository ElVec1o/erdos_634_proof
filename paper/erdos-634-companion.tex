...
\begin{remark}[Close pairs]\label{rem:closepairbase}\lab{HEURISTIC}
Close pairs ($f^2\le2ef+e^2$) admit in addition finitely many decompositions with $y>e$, computable
per member. Finiteness is immediate from the walk equation; the count itself is a computation and is
not proved uniformly in $(e,f)$.
\end{remark}
