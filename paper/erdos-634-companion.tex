...
(interior to a side), or the corner angle --- the \texttt{Dissection.HasAngleSums} class, the one
open geometric obligation; the passage from these real equations to the integer multiplicities
consumed by the fills is proved (\texttt{Geometry.vertex\_multiplicities}, with
$\alpha/\pi\notin\Q$ proved at every member). (ii) \emph{Coverings}: each side of a wall segment
