...
junction --- the head of the engine's second cascade. The remaining instantiations are the flank
identification (the corner theory of Theorem~\ref{thm:e1reduce}) and the covering data
(\texttt{wall\_partition}) at the junction. An adversarial
