...
Let the tile be inflated by $f$, so its sides are $fa$, $fb$, $fc$, and suppose $\beta/\alpha\notin
\mathbb Z$. Then the $\alpha$- and $\beta$-corners of the inflated triangle are each met by a single
...
$2\alpha>\alpha$; and a $\beta$-corner splits only as $k\alpha=\beta$, excluded by
$\beta/\alpha\notin\mathbb Z$, which holds at both members ($3.190\ldots$ and $2.136\ldots$).
\end{proof}
