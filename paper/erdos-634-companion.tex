...
\begin{theorem}[The inflation is rigid at the first four members]\label{thm:inflrigid}
The inflated tile of Proposition~\ref{prop:inflbdy} admits no tiling by $f^2$ copies whose $c$-side
carries the $p=1$ word, at $(1,3)$, $(2,5)$, $(3,7)$ and $(4,9)$. Its only boundary is therefore the
standard one, $a^f$, $b^f$, $c^f$.
\end{theorem}
...
profile $(9,0,5)$ gives \texttt{EXHAUSTED\_NO\_TILING} in $5\,161\,190$ nodes.
...
At $(1,3)$, $(2,5)$, $(3,7)$ and $(4,9)$: if the west corner block is complete, then the equal side on that side
carries no $a$-edge.
\end{corollary}
