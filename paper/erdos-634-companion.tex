...
sorting the chain along the base and knowing that consecutive edges share an endpoint, which is a
contiguity fact not supplied by the measure-theoretic partition --- and the input that an
