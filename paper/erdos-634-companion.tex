...
from $R=4$ to $R=7$, and each step is the exclusion of the base word $a\,c\,a\,b\,a^{f-3}$,
...
\begin{theorem}[The family is not uniform]\label{thm:notuniform}\lab{CONJECTURE}
