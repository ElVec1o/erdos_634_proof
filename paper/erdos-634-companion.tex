...
The arithmetic half is formalized (\texttt{lean/Erdos634/FanKill.lean}, axiom-clean):
...
least the minimal tile angle fits in it. The open half is the geometric forcing --- that every tile
meeting the junction from inside the wedge presents exactly $\alpha$ there --- together with the
finite side-case analysis that the traces enumerate. Under those, the $(4,2)$ word dies at every
