...
311,\dots$, of which $23$ and $39$ were previously settled by exhaustive search and $11$ by
Theorem~\ref{thm:basebeta-e1}.
...
\texttt{.side\_p\_bound}) but not the geometric steps of Theorem~\ref{thm:apexconfig} and
Corollary~\ref{cor:noTP} on which Theorem~\ref{thm:secondc} rests. The non-representability of $a-b$
