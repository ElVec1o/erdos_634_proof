...
\begin{remark}[Where the hypothesis $a<b$ is used, and what is known about removing it]\label{rem:abnecessary}
...
That is a statement about this proof, not about the theorem, and we do not claim more. No
counterexample to the \emph{conclusion} is known at any member with $b<a$. Indeed at $(2,3)$ and
$(3,4)$ the $m=1$ target is exhausted by search, so there the conclusion holds vacuously; at
$(4,5)$, $(5,6)$, $(5,7)$, $(5,8)$, $(6,7)$, $(7,8)$, $(7,9)$, $(7,10)$, $(7,11)$ the status is
simply unknown. Whether Theorem~\ref{thm:secondc} extends below the golden-ratio threshold is open.
\end{remark}
