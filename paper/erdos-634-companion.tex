...
\begin{theorem}[The two equal sides cannot both be mirrored]\label{thm:nobothmirror}
Assume $e^{2}+ef<f^{2}$. Then the two equal sides do not both carry the figure $\{3\alpha,2\beta\}$ at
their last junctions. Hence at least one carries $\{\gamma,\alpha,\beta\}$.
\end{theorem}
...
$T_2$ and of the mirror partner meet --- contradicting the dissection. The same computation applies to
whichever ray carries the $c$, by reflection.
\end{proof}
