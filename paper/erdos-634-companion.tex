...
through-tile exclusions, the congruence layer, and a counting lemma). The assembly of the
catalogue rows along the word, with the run equations, is the remaining work. Also open: the
