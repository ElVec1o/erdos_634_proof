...
\begin{corollary}\label{cor:walls15}\lab{PROVED, from reach $3$}
...
\begin{theorem}[The column $(0,e,2e)$ admits no tiling]\label{thm:n1}\lab{PROVED}
...
\begin{corollary}\label{cor:basewalls}\lab{PROVED}
