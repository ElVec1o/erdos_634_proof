...
(\texttt{pincer\_sharp}), and enumerating the escapes at that $f$ gives exactly two families, the
constant $(4,2)$ and a growing $(f-1,f+1)$. Excluding the constant one alone changes nothing, and
excluding both advances the bound by exactly one before four further escapes appear. Each $f$
therefore costs its own reach step.
\end{remark}
