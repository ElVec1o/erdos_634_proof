...
\begin{theorem}[Hypothesis~\ref{hyp:walls} on the family $e=f-1$]\label{thm:efminus1}
Let $e=f-1$ with $f\ge2$. Then every equal side of the base-$\beta$ target at $m=1$ has $p=0$; that is,
Hypothesis~\ref{hyp:walls} holds at every such member.
\end{theorem}
