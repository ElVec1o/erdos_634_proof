...
showing the overshoot absent. Second, the overshoot being exactly $a$ --- and $E$ lying on the same
horizontal line as a whole $c$-edge, one $a$-length past its end --- is a strong constraint on what
that mechanism can be, and is the natural place to look next.
\end{remark}
