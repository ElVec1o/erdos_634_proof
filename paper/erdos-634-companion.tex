...
\begin{proposition}[The golden-ratio hypothesis is removable]\label{prop:nogolden}
...
\begin{theorem}[The side parameter vanishes on the family $e=f-1$]\label{thm:efminus1}
...
\begin{proposition}[The inflated boundary]\label{prop:inflbdy}
...
\begin{corollary}[The crux, on $f^2$ tiles]\label{cor:inflcrux}
...
\begin{theorem}[The inflation is rigid at every member searched]\label{thm:inflrigid}
...
\begin{corollary}[Remark~\ref{rem:sidenoa}'s step, proved]\label{cor:sidenoa-proved}
...
\begin{proposition}[Edge parity kills the $p=1$ boundary when $e$ and $f$ differ in parity]\label{prop:inflparity}
...
\begin{corollary}[The $p=1$ word needs two $c$-edges, so $e=f-1$ is rigid]\label{cor:twoc}
...
\begin{proposition}[The orientation of a boundary $a$-run is monotone]\label{prop:orientmono}
...
\begin{lemma}[Boundary words at scale $k$]\label{lem:rowwords}
...
\begin{lemma}[The corner tile]\label{lem:rowp0}
...
\begin{lemma}[The first partner, and the parallelogram]\label{lem:rowq0}
...
\begin{lemma}[The row advance at $Y_0$]\label{lem:rowp1}
...
\begin{proposition}[The slot dichotomy]\label{prop:slotdichotomy}
...
\begin{corollary}[The induction step]\label{cor:rowinduction}
...
\begin{proposition}[The relation lattice, and the interface floor]\label{prop:rellattice}
...
\begin{theorem}[The certified seeds are $(1,2)$-degenerate]\label{thm:seeddegenerate}
...
\begin{proposition}[Cevian reduction: two tiles and an atom]\label{prop:cevianatom}
...
\begin{lemma}[The W-parallelogram, $e=1$]\label{lem:wpgram}
...
\begin{theorem}[W-addition, and the second complete pair]\label{thm:wfamily}
...
\begin{proposition}[Wide parallelograms, all $(e,f)$]\label{prop:widecol}
...
\begin{theorem}[Addition law]\label{thm:addlaw}
