...
of length $1$ lying below every generator of $\langle f,f^2-1,f^2\rangle$.
...
\beta/\alpha\rfloor}$. The fan constant is thus shared across orbits; what varies per orbit is
the finite head. We state plainly that the forcing is an instance of the crossing question and is
