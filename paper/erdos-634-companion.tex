...
least the minimal tile angle fits in it. What remains outside arithmetic has shrunk to two standard interface facts --- a straight tiling
segment is covered by whole tile edges, and the tiles at a vertex inside a wedge have angles
summing to at most the wedge --- together with the completeness of the candidate enumeration,
which is the engine's own certified soundness. Under those, the $(4,2)$ word dies at every
