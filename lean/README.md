...
the Lean:
```
python3 gencert.py ../code/engine/tilings/tiling_99_isobeta_24_24_33.txt Tiling99.lean Tiling99 ISOB:99:9
```
...
- `CevianTiling28.lean`, `CevianTiling63.lean` — the cevian pieces of Δ₂ and Δ₃ at (1,2)
  ...
  `code/rust/tiler cert`, the Rust port of the certificate generators.
