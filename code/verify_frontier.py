...
For each N in {14, 15, 21, 22, 30, 46}, every branch of the Laczkovich classification is checked by an exact
...
print("=" * 96)
print("Branch sweep for N = 14, 15, 21, 22, 30, 46  (with the parity law M == N mod 2)")
print("=" * 96)

for N in (14, 15, 21, 22, 30, 46):
