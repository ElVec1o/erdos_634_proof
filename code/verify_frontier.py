#!/usr/bin/env python3
"""
verify_frontier.py  --  the branch sweep for N = 14 and N = 15 (Section 8 of the paper).

For each N in {14, 15}, every branch of the Laczkovich classification is checked by an exact
...
print("=" * 96)
print("Branch sweep for N = 14, 15")
print("=" * 96)
...
for N in (14, 15):
    ...
    sols = [M for M in range(1, isqrt(N) + 1) if M * M < N
